...
const rules = {
  ...
  fp : 'Ang larong "Simon Says" ay isang pagkakasunod-sunod ng mga kulay (tulad ng pula, lila, berde, dilaw), at kailangan mong ulitin ito nang eksakto sa pamamagitan ng pag-click o pagpindot sa tamang mga key. Sa bawat round, humahaba ang pagkakasunod-sunod. Kung magkamali ka, matatalo ka at magsisimula ulit. Ang layunin ay talunin ang iyong pinakamataas na score sa pamamagitan ng pag-alala sa pinakamahabang sequence na kaya mo.',
  fr : 'Le jeu "Simon Says" est une séquence de couleurs (comme rouge, violet, vert, jaune), et vous devez la répéter exactement en cliquant ou en appuyant sur les bonnes touches. À chaque tour, la séquence s’allonge. Si vous vous trompez, vous perdez et devez recommencer. L’objectif est de battre votre meilleur score en mémorisant la plus longue séquence possible.'
};
